...
import logo from './../../../assets/brand/kakeiz.png';
import cakeshop from '../../../assets/cakeshop.jpg'; // Import the background image
...
const Login = () => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `url(${cakeshop})`,  // Set background image
